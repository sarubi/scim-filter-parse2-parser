...
final public class Rule_query extends Rule
{
  public Rule_query(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_query parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_query(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
