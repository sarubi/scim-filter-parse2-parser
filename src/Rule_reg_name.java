...
final public class Rule_reg_name extends Rule
{
  public Rule_reg_name(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_reg_name parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_reg_name(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
