...
final public class Rule_pchar extends Rule
{
  public Rule_pchar(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_pchar parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_pchar(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
