...
final public class Rule_userinfo extends Rule
{
  public Rule_userinfo(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_userinfo parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_userinfo(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
