...
final public class Rule_filterDash extends Rule
{
  public Rule_filterDash(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_filterDash parse(ParserContext context)
  {
    context.push("filterDash");
    ...
    if (parsed)
    {
        rule = new Rule_filterDash(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("filterDash", parsed);

    return (Rule_filterDash)rule;
  }
}
