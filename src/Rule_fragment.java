...
final public class Rule_fragment extends Rule
{
  public Rule_fragment(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_fragment parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_fragment(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
